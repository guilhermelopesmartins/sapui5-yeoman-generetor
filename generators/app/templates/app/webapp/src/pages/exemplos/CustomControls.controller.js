sap.ui.define(
  ...
  function (BaseController, MessageToast, RestModel, ColorPickerPopover) {
    ...
    return BaseController.extend("<%= appName %>.src.pages.exemplos.CustomControls", {
      ...
      onSerchDimession: function (oEvent) {
        ...
        if (!this._oDialogDimensions) {
          this._oDialogDimensions = sap.ui.xmlfragment("<%= appName %>.view.fragments.ChooseFromModal", this);
